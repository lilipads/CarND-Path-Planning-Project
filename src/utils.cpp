...
// vector<double> jerk_constrained_spacings(double current_velocity, double current_acceleration, 
...
// 		}
// 		else {
// 			current_acceleration = max(current_acceleration - EXPECTED_JERK * WAYPOINT_INTERVAL, 0);
// 		}
// 		current_velocity += current_acceleration;
// 		spacings.push_back(current_velocity * WAYPOINT_INTERVAL);
// 	}
// 	return spacings;
// }
...
// 	double epsilon = 1;
// 	double y = s(x);
// 	double y1 = s(x + epsilon);
// 	return atan2(y1 - y, epsilon);
// }
